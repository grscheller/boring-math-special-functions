...
..admonition:: Module special_functions.complex
    ...
    | Function    | Description          | Type                   |
    +=============+======================+========================+
    | ``exp0(z)`` | exponential function | ``complex -> complex`` |
    +-------------+----------------------+------------------------+
    | ``sin0(z)`` | sine function        | ``complex -> complex`` |
    +-------------+----------------------+------------------------+
    | ``sin0(z)`` | cosine function      | ``complex -> complex`` |
    +-------------+----------------------+------------------------+
    | ``tan0(z)`` | tangent function     | ``complex -> complex`` |
    +-------------+----------------------+------------------------+
